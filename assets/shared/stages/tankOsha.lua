...
function onCreate()
	...
	makeLuaSprite('tankSky', 'backgrounds/wasteland/tankSky', -400, -400);
	setScrollFactor('tankSky', 0, 0);

	makeLuaSprite('tankBuildings', 'backgrounds/wasteland/tankBuildings', -200, 0);
	setScrollFactor('tankBuildings', 0.3, 0.3);
	scaleObject('tankBuildings', 1.1, 1.1);

	makeLuaSprite('tankRuins', 'backgrounds/wasteland/tankRuins', -200, 0);
	setScrollFactor('tankRuins', 0.35, 0.35);
	scaleObject('tankRuins', 1.1, 1.1);

	makeAnimatedLuaSprite('tankWatchtower', 'backgrounds/wasteland/tankWatchtower', 100, 50);
	addAnimationByPrefix('tankWatchtower', 'idle', 'watchtower', 24, false);
	setScrollFactor('tankWatchtower', 0.5, 0.5);

	makeAnimatedLuaSprite('tankRolling', 'backgrounds/wasteland/tankRolling', 300, 300);
	addAnimationByPrefix('tankRolling', 'idle', 'BG tank w lighting', 24, true);
	setScrollFactor('tankRolling', 0.5, 0.5);

	makeLuaSprite('tankGround', 'backgrounds/wasteland/tankGround', -420, -150);
	...
	if not lowQuality then
		makeLuaSprite('tankClouds', 'backgrounds/wasteland/tankClouds', getRandomInt(-700, -100), getRandomInt(-20, 20));
		setScrollFactor('tankClouds', 0.1, 0.1);
		setProperty('tankClouds.velocity.x', getRandomInt(5, 15));

		makeLuaSprite('tankMountains', 'backgrounds/wasteland/tankMountains', -300, -20);
		setScrollFactor('tankMountains', 0.2, 0.2);
		scaleObject('tankMountains', 1.2, 1.2);

		makeAnimatedLuaSprite('smokeLeft', 'backgrounds/wasteland/smokeLeft', -200, -100);
		addAnimationByPrefix('smokeLeft', 'idle', 'SmokeBlurLeft');
		setScrollFactor('smokeLeft', 0.4, 0.4);

		makeAnimatedLuaSprite('smokeRight', 'backgrounds/wasteland/smokeRight', 1100, -100);
	...
	-- foreground shit
	makeAnimatedLuaSprite('tank0', 'backgrounds/wasteland/tank0', -500, 650);
	addAnimationByPrefix('tank0', 'idle', 'fg', 24, false);
	setScrollFactor('tank0', 1.7, 1.5);
	
	makeAnimatedLuaSprite('tank2', 'backgrounds/wasteland/tank2', 450, 940);
	addAnimationByPrefix('tank2', 'idle', 'foreground', 24, false);
	setScrollFactor('tank2', 1.5, 1.5);
	
	makeAnimatedLuaSprite('tank5', 'backgrounds/wasteland/tank5', 1620, 700);
	addAnimationByPrefix('tank5', 'idle', 'fg', 24, false);
	setScrollFactor('tank5', 1.5, 1.5);
	
	if not lowQuality then
		makeAnimatedLuaSprite('tank1', 'backgrounds/wasteland/tank1', -300, 750);
		addAnimationByPrefix('tank1', 'idle', 'fg', 24, false);
		setScrollFactor('tank1', 2.0, 0.2);
		
		makeAnimatedLuaSprite('tank4', 'backgrounds/wasteland/tank4', 1300, 900);
		addAnimationByPrefix('tank4', 'idle', 'fg', 24, false);
		setScrollFactor('tank4', 1.5, 1.5);
		
		makeAnimatedLuaSprite('tank3', 'backgrounds/wasteland/tank3', 1300, 1200);
