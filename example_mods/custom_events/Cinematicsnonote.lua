...
function onUpdate()
	...
	doTweenY('Cinematics1', 'UpperBar', 0, 0.5, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 600, 0.5, 'Linear')
	noteTweenY('NOTEMOVE1', 0, 680, 0.5, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 680, 0.5, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 680, 0.5, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 680, 0.5, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 680, 0.5, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 680, 0.5, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 680, 0.5, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 680, 0.5, 'Linear')
	doTweenAlpha('AlphaTween1', 'healthBarBG', 0, 0.25)
	doTweenAlpha('AlphaTween2', 'healthBar', 0, 0.25)
	doTweenAlpha('AlphaTween3', 'scoreTxt', 0, 0.25)
	doTweenAlpha('AlphaTween4', 'iconP1', 0, 0.25)
